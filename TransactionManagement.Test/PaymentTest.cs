    ...
    public class PaymentTest
    {
        ...
        public async Task Can_Create_Payment()
        {
            try
            {
                ...
                {
                    var newTransaction = await uow.Transactions.GetTransactionById("4face5b6-6758-4092-80ec-bbb24865751c");
                    newTransaction.AddPayment("ptcq", "pmp", "123456", "bdb", DateTime.Today.AddMonths(1), DateTime.Today.AddMonths(1), 7000m, "");
                    await uow.SaveChanges();
                    var transaction = await uow.Transactions.GetTransactionById("4face5b6-6758-4092-80ec-bbb24865751c");
