...
namespace Sunrise.Client.Helpers.Validations
{
    ...
    public sealed class CustomDateEndStartValidation : PropertyValidationAttribute
    {
        ...
        public CustomDateEndStartValidation(string otherProperty, ValueComparison comparison)
            : base(otherProperty)
        {
