...
namespace VillaManagement.Test.Real
{
    ...
    public class VillaUnitTest
    {
        ...
        public async Task Can_Add_Villa()
        {
            ...
            {
                var villa = Villa.Map("V102", "S02", "E1000", "W10000", "12335", "rtff", 10, "Fully furnished",4500m);
        ...
        public async Task Can_Save_BigData()
        {
            ...
            using (var uow = new UnitOfWork())
            {
                ...
                for (var i = 46; i < 145; i++)
                {
                    ...
                    var villa = Villa.Map("V0" + i,"S01", "E1000"+i, "W10000"+i, "12335", "rtff", 10, "Fully furnished", rate);
                    villas.Add(villa);
                }
